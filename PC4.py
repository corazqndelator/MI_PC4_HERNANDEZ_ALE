...
if pagina_seleccionada == 'Inicio': #volvemos a la condicional de inicio para añadir el contenido de la página
...
elif pagina_seleccionada == 'Experiencia': #ahora paso a la parte de mi experiencia donde le coloco el titulo
...
#ahora paso a la sección de graficos colocando que irá en esa parte
elif pagina_seleccionada == 'Visualizaciones':
